...
def add_to_bag(request, item_id):
    ...
    if item_id in list(bag.keys()):
        ...
        messages.success(
            request,
            f'Added {quantity} more {hours} of '
            f'{developer.name} to your bag. Total hours: {bag[item_id]}')
    else:
        bag[item_id] = quantity
        messages.success(
            request,
            f'Added {quantity} {hours} of '
            f'{developer.name} to your bag')
...
def adjust_bag(request, item_id):
    """Adjust the quantity of the specified
     developer to the specified amount"""
    ...
    if quantity > 0:
        ...
        messages.success(
            request,
            f'Updated hours of {developer.name}'
            f' to your bag to {quantity}')
    else:
        bag.pop(item_id)
